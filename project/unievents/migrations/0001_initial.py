    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, db_column='image', upload_to='')),
            ],
            options={
                'db_table': 'location',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, db_column='description', null=True)),
                ('avatar_image', models.ImageField(blank=True, db_column='avatar_image', upload_to=unievents.models.uni_image_upload_to)),
                ('email_domain', models.TextField(db_column='email_domain')),
                ('location', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, to='unievents.location')),
            ],
            options={
                'db_table': 'university',
            },
